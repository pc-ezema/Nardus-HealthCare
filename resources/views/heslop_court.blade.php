                        ...
                        <div class="vc_column-inner ">
                            <div class="wpb_wrapper">
                                <div class="sec-title no-underline" style="margin-top: 40px; text-align: left !important; padding-left: 1.5rem;">
                                    <h3>Address: 1 Heslop Court, Stubbing Lane, Worksop, S80 1YH  1 bed residential</h3>
                                </div>
                                <!--Featured Three Column-->
                                <div class="container">
                                    <div class="box">
                                        <img src="images/heslop-court/1.jpeg" alt="Heslop Court">
                                    </div>
                                    <div class="box">
                                        <img src="images/heslop-court/2.jpeg" alt="Heslop Court">
                                    </div>
                                    <div class="box">
                                        <img src="images/heslop-court/3.jpeg" alt="Heslop Court">
                                    </div>
                                </div>
                                <div class="container">
                                    <div class="box">
                                        <img src="images/heslop-court/4.jpeg" alt="Heslop Court">
                                    </div>
                                    <div class="box">
                                        <img src="images/heslop-court/5.jpeg" alt="Heslop Court">
                                    </div>
                                    <div class="box">
